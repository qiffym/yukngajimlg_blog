...
import { cn, kebabCase } from '@/lib/utils.js';
...
export function TableOfContents({ articleId }) {
    ...
    return (
        <aside className="hidden rounded-lg border bg-secondary/10 p-4 lg:block">
                    ...
                    {headings.map((heading, index) => (
                        <li
                            ...
                            className={cn(
                                ...
                                'text-sm tracking-tight text-foreground/70 transition first:hidden hover:text-foreground [&>a.active]:font-semibold [&>a.active]:text-foreground',
                            )}
                        >
